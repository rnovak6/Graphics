...
static void Wedge(double x, double y, double z, double r){
    ...
    glTexCoord2f(1,1); glVertex3f(0,1,-2);
    ...
    glTexCoord2f(1,1); glVertex3f(0,0,-2);
    glEnd();
    //side
    glBindTexture(GL_TEXTURE_2D,rock);
    glBegin(GL_POLYGON);
...
static void House(double x, double y, double z, double r, double sx, double sy, double sz){
    ...
    glBegin(GL_POLYGON);
    glNormal3f(-2,-2,0);
    glTexCoord2f(1,0); glVertex3f(0,2,2);
    glTexCoord2f(1,1); glVertex3f(1,3,2);
    ...
    glBegin(GL_POLYGON);
    glNormal3f(2,2,2);
    glTexCoord2f(0,0); glVertex3f(1,3,2);
    glTexCoord2f(1,0); glVertex3f(1,3,0);
    glTexCoord2f(1,1); glVertex3f(2,2,0);
    glTexCoord2f(0,1); glVertex3f(2,2,2);
    glEnd();
    //roof front
...
int main(int argc, char *argv[])
{
    //  Initialize GLUT and process user parameters
     ...
     //  Create the window
     glutCreateWindow("Ryan Novak HW6: Texture");
